                ...
                <div class="hidden sm:flex sm:items-center sm:ms-10 space-x-6">
                    ...
                    @role('admin')
                        ...
                        <x-nav-link
                            ...
                            :active="request()->routeIs('matakuliah.*')">
                            Mata Kuliah
                        </x-nav-link>
                    ...
                    @role('mahasiswa')
                        ...
                        <x-nav-link
                            ...
                            :active="request()->routeIs('mahasiswa.jadwal')">
                            Jadwal
                        </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }"
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @role('admin')
                ...
                <x-responsive-nav-link :href="route('dosen.index')">
                    Dosen
                </x-responsive-nav-link>
            ...
            @role('mahasiswa')
                ...
                <x-responsive-nav-link :href="route('krs.index')">
                    KRS
                </x-responsive-nav-link>

                <x-responsive-nav-link :href="route('mahasiswa.jadwal')">
                    Jadwal
                </x-responsive-nav-link>
